...
export const DISPLAY_SELECTED_EXERCISE = 'DISPLAY_SELECTED_EXERCISE'
export const EDIT_SELECTED_EXERCISE = 'EDIT_SELECTED_EXERCISE'
export const DELETE_SELECTED_EXERCISE = 'DELETE_SELECTED_EXERCISE'
